...
if (isset($_GET['check_csv'])) {
    ...
    echo "<h3>CSV Content (Locked Format - movie_name,message_id,channel_id):</h3>";
    if (file_exists(CSV_FILE)) {
        $lines = file(CSV_FILE);
...
if (!isset($update) || !$update) {
    ...
    echo "<ul>";
    echo "<li>✅ CSV Format Locked: movie_name, message_id, channel_id</li>";
    echo "<li>✅ Hinglish Language Support</li>";
    echo "<li>✅ Smart Search with 'Did You Mean' suggestions</li>";
    echo "<li>✅ Simple Totalupload Keyboard with First/Mid/Last buttons</li>";
    echo "<li>✅ Smart Forwarding Control: Public channels show forwarded from, private channels hide it</li>";
    echo "<li>✅ Typing Indicators System: Shows 'typing...' when bot is processing</li>";
    echo "</ul>";
    ...
    echo "<li>✅ Multi-language support (Hindi/English/Hinglish)</li>";
    ...
    echo "<li>✅ <b>SMART FORWARDING:</b> Public channels show 'forwarded from', private channels hide it</li>";
    ...
    echo "<li>✅ TYPING INDICATORS: Shows 'typing...' when bot is working</li>";
